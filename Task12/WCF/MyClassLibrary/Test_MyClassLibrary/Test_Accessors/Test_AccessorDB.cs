...
namespace Test_MyClassLibrary.Test_Accessors
{
    ...
    class Test_AccessorDB
    {
        ...
        public void Test_AccessorDB_CountWellsInOilfield()
        {
            ...
            var accessor = CreateAccessorDb();
            accessor.Dal = fake;
            fake.GetOilfieldById(Arg.Any<int>()).Returns(CreateOilfieldAlacaevka());

            //act
            var rez = accessor.CountWellsInOilfield(1);
        ...
        public void Test_AccessorDB_GetNameByIndex()
        {
            ...
            var accessor = CreateAccessorDb();
            accessor.Dal = fake;
            fake.GetNameByIndex(Arg.Any<int>()).Returns("hello");

            //act
            accessor.GetNameByIndex(1);

            //assert
            fake.Received().GetNameByIndex(1);
